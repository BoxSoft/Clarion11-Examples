...
AppFrame             APPLICATION('SoftVelocity University'),AT(,,400,266),FONT('MS Sans Serif',8,COLOR:Black),RESIZE, |
  ALRT(MouseLeft2),CENTER,ICON('_SoftVUn.ico'),IMM,MAX,HLP('~TopSpeedUniversity'),STATUS(-1, |
  80,120,45),SYSTEM,WALLPAPER('SoftV-u.bmp')
  ...
  ' Description')
                         ...
                         END
                       END
                       TOOLBAR,AT(0,1,400,16),USE(?TOOLBAR1)
