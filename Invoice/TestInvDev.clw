   ...
   MAP
     MODULE('TESTINVDEV_BC.CLW')
DctInit     PROCEDURE                                      ! Initializes the dictionary definition module
DctKill     PROCEDURE                                      ! Kills the dictionary definition module
     END
!--- Application Global and Exported Procedure Definitions --------------------------------------------
     MODULE('TESTINVDEV001.CLW')
MainTestDev            PROCEDURE   !Wizard Application 
MakeGUID               FUNCTION(),STRING   !
     END
     MODULE('TESTINVDEV005.CLW')
RandomizeRandoms       PROCEDURE   !
SmashSpaces            PROCEDURE(*string Txt)    !
TestDataAddress        PROCEDURE(*STRING outStreet, *STRING outCity, *STRING outState, *STRING outZip, BOOL ZipPlus4=0)   !
TestDataFirstLast      PROCEDURE(*STRING FName, *STRING LName)   !
TestDataLorem          FUNCTION(USHORT Bytes2Return=30),STRING   !
TestDataPhone          FUNCTION(),STRING   !
TestDataStateCode      PROCEDURE(*STRING outState, <*STRING outZip>, BOOL ZipPlus4=0)   !
TestDataWord           FUNCTION(),STRING   !Return 1 latin word of 5 to 12 bytes
Err4Msg                FUNCTION(Byte FmtType=0),STRING   !Format Error() functions for message or (1) for log
     END
   END
...
Access:TestCompanyCSV &FileManager,THREAD                  ! FileManager for TestCompanyCSV
Relate:TestCompanyCSV &RelationManager,THREAD              ! RelationManager for TestCompanyCSV
...
Destruct               PROCEDURE
  ...
  INIMgr.Init('.\TestInvDev.INI', NVD_INI)                 ! Configure INIManager to use INI file
  DctInit()
  MainTestDev
  INIMgr.Update
